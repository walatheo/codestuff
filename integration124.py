...
def calculate_taxes_on_pizza():
    """
defines the function calcuate teaxes on pizza where the tax is given and
...
def main():
 ...
 Completes the multiplicative identity for the second function
    """
    number_by_1 = int(input('put in number to calculaye the tax on pizza'))
...
print("the goal is to be the closest to the numberer 21 without going over")
